...
// Number of products sold (count of order items with paid orders)
$products_sold = $pdo->prepare("
...
<!DOCTYPE html>
<html>
<head><title>Seller Dashboard - C2C Market</title><link rel="stylesheet" href="assets/css/style.css"></head>
<body>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <?php if($status != 'approved'): ?>
                <div><a href="verify_request.php" class="btn-sm btn">Request Verification</a></div>
            <?php endif; ?>
        </div>
    </div>
